...
const messageInput = document.querySelector('#message-input'),
  ...
  onlines = document.querySelector('#online-users');
socket.emit('send nickname', { nickname: localStorage.getItem('nickname') });
...
socket.on('send message', (data) => {
  ...
  let message = `  <div>${data.nickname}</div>
  <div class="d-flex justify-content-start mb-4">
    ...
    <div class="msg_cotainer">
      ${data.message}
      <span class="msg_time">${date.getHours()}:${date.getMinutes()} , ${
    weekday[date.getDay()]
  }</span>
    </div>
  </div>`;
...
socket.on('send message2', (data) => {
  ...
  let message = `	<div class="d-flex justify-content-end mb-4">
    <div class="msg_cotainer_send">
        ${data.message}
        <span class="msg_time_send">${date.getHours()}:${date.getMinutes()} , ${
    weekday[date.getDay()]
  }</span>
    </div>
    <div class="img_cont_msg">
